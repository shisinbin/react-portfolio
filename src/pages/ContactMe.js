    ...
    <main id='contact'>
      <div className='contact-content'>
        ...
        <p>
          ...
          from you. Either click on my email address or fill out the form below
          and let's start a conversation.
        </p>
        <a href='mailto:shisinbin@gmail.com'>
          <i className='far fa-envelope'></i> shisinbin@gmail.com
        </a>
      </div>
